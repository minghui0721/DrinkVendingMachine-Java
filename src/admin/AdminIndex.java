...
public class AdminIndex extends JPanel {
    ...
    public AdminIndex(JFrame adminFrame) {
    ...
    private void initComponents() {
        ...
        button3.setLabel("Staff Management");
        // Add action listener for the button3 (Staff Management) here
         button3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                // Open the ProfileUpdate page here
        ...
        button4.setLabel("Report Generation");
        // Add action listener for the button4 (Report Generation) here
        button4.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ReportGeneration reportGenrate = new ReportGeneration();
                reportGenrate.setVisible(true);
            }
        });
        ...
        button5.setLabel("Discount Management");
        ...
        button5.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Open the DiscountSet frame
                DiscountManagement discountSet = new DiscountManagement();
                discountSet.setVisible(true);
            }
        });
       ...
       button6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                // Close the current JFrame (AdminIndex)
                JFrame currentFrame = (JFrame) SwingUtilities.getWindowAncestor(AdminIndex.this);
                currentFrame.dispose();
