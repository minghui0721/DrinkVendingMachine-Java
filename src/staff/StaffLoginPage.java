...
import main.VendingMachineMain;
    ...
    public class StaffLoginPage extends JPanel {
        ...
        private String loggedInUsername = ""; // Declare it at the class level
        ...
        public StaffLoginPage() {
           ...
           loginButton.addActionListener(e -> {
                ...
                if (enteredUsername.equals(usernamePlaceholder) || enteredPassword.length == 0) {
                    ...
                    // Load data from 'data/staff.txt' to check username and password
                    ...
                    try (BufferedReader reader = new BufferedReader(new FileReader("data/staff.txt"))) {
                        ...
                        while ((line = reader.readLine()) != null) {
                            ...
                            if (enteredUsername.equals(username) && new String(enteredPassword).equals(password)) {
                                loggedIn = true;
                                loggedInUsername = enteredUsername; // Assign the logged-in username
                                break;
                            }
                        }
                    ...
                    if (loggedIn) {
                        ...
                        // Create an instance of AdminIndex and add it to the frame's content pane
                        StaffIndex staffIndex = new StaffIndex(staffFrame, loggedInUsername);
                        staffFrame.getContentPane().add(staffIndex, BorderLayout.CENTER);
                    } else {
        ...
        public static void main(String[] args) {
            SwingUtilities.invokeLater(() -> {
                ...
                frame.getContentPane().add(staffLoginPage);
